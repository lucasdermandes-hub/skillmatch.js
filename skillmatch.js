...
function exibirMensagemFinal(nome) {
  console.log(`´${nome}, revise suas habilidades faltantes e atualize se for necessário`);
}

// Função que vai processar e análisar todas as vagas

// Função que processa e analisa todas as vagas
